...
if __name__ == '__main__':
    ...
    test_iter = data_loader.load_train_val_test_data(test_file_path=model_config.test_file_path, only_test=True)
    ...
    token_ids, pred_idx, mask = data_loader.make_inference_samples(
        sentences, masked=False, language='zh', random_state=2022)
